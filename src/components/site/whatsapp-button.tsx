...
export function WhatsAppButton({
  message = "Hello Jiro's Trading, I'd like to trade a gift card.",
  ...
  const variantClasses = {
    ...
    outline:
      "bg-transparent text-[#0a2540] border-2 border-[#0a2540] hover:bg-[#0a2540] hover:text-white",
    dark: "bg-[#0a2540] text-white hover:bg-[#14365c] shadow-lg shadow-[#0a2540]/25",
  };
