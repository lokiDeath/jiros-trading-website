...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      href={whatsappLink(
        "Hello Jiro's Trading, I'd like to trade a gift card."
      )}
      target="_blank"
    ...
    >
      <div className="relative">
        ...
        {/* Tooltip */}
        <div className="absolute right-full mr-3 top-1/2 -translate-y-1/2 whitespace-nowrap bg-white text-[#0a2540] text-xs font-semibold px-3 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
          Chat with us
